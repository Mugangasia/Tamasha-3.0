    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Tamasha Africa</h3>
            <p className="text-gray-400">
              Bringing authentic African cultural experiences to your doorstep.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/cultures" className="text-gray-400 hover:text-white">
                  Explore Cultures
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>Email: INFO@TAMASHAAFRICA.COM</li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400">
            © {currentYear} Tamasha Africa. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
